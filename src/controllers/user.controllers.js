...
const getUserChannelProfile = asyncHandler(async(req,res) => {
    ...
    const channel = await User.aggregate([
        ...
        // count how many subscriber pipeline
        {
            $lookup:{
                from:"subscriptions",
                localField:"_id",
        ...
        // how many channel you have subscribed pipeline
        {
            $lookup:{
                from:"subscriptions",
                localField:"_id",
        ...
        // original user object ke andar kuch fields add kare hain
        {
            $addFields:{
                subscribersCount:{
                    $size:"$subscribers"
        ...
        // project pipeline for giving some selected things
        {
            $project:{
                fullName:1,
                username:1,
